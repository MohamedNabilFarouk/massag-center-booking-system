...
@endif
@if(\App\Libs\ACL::can('export-'.$module))
<a href="{{url('admin')}}/{{$module}}/export" class="btn btn-warning"><i class="fa fa-plus"></i> {{trans('admin.Export')}}</a>
@endif
                        <table class="user-list-table table">
                            <thead class="thead-light">
                                <tr>
                                    <th width="5%">{{trans('admin.ID')}} </th>
                <th width="20%">{{trans('admin.Email')}}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-danger btn-xs" href="{{$module}}/delete/{{$row->id}}" title="{{trans('admin.Delete')}}" data-title="{{trans('admin.Confirmation message')}}" data-confirm="{{trans('admin.Are you sure you want to delete this subscriber')}}?">
