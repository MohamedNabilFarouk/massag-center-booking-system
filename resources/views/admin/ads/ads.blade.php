                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <div class="dropdown my-auto">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a class="dropdown-item" href="{{ url('admin/ads/edit', $ad->id) }}">
                                                            <i data-feather="edit" class="align-middle mr-50"></i>
                                                            <span class="align-middle">Edit</span>
                                                        </a>

                                                        {!! Form::open(['method' => 'DELETE', 'url' => url('admin/ads/delete'.'/'.$ad->id), 'style' => 'display:inline']) !!}
                ...
                <div class="modal modal-slide-in sidebar-todo-modal fade" id="new-task-modal">
                    <div class="modal-dialog sidebar-lg">
                        <div class="modal-content p-0">
                            ...
                            <form method="post" action="url('admin/ads/create')" enctype="multipart/form-data"
