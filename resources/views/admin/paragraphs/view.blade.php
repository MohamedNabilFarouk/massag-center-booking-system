...
@section('content')
				...
				<div class="card">
                        <h5 class="card-header">View Paragraph</h5>
                                <div class="card-body">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{url('admin')}}/dashboard">Home</a></li>
                                            <li class="breadcrumb-item"><a href="{{url('admin')}}/paragraphs">List Paragraphs </a></li>
                                            <li class="breadcrumb-item active" aria-current="page">View Paragraph</li>
                                        </ol>
                                    </nav>
                                </div>
                    </div>
...
<div class="table-responsive">
    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered pull-left">
        <tr>
            <td width="25%" class="align-left">{{trans('admin.Page')}}</td>
            <td width="75%" class="align-left">{{$row->page->title}}</td>
        </tr>
        <tr>
