...
{{-- @dd(app()->getLocale()); --}}
<div class="card">
                        <h5 class="card-header">{{__('Blog')}}</h5>
                    </div>
...
<a href="{{$module}}/create" class="btn btn-success"><i class="fa fa-plus"></i> {{__('create')}}</a>
@endif
                        <table class="user-list-table table">
                            <thead class="thead-light">
                                <tr>
                                    <th width="5%">#</th>
                                    <th width="25%">{{__('Title En')}}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-danger btn-xs" href="{{$module}}/delete/{{$row->id}}" title="{{trans('admin.Delete')}}" data-title="{{trans('admin.Confirmation message')}}" data-confirm="{{ trans('Are you sure?') }}">
