...
@section('content')
				...
				<div class="card">
                        <h5 class="card-header">Create Slide</h5>
                                <div class="card-body">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{url('admin')}}/dashboard">Home</a></li>
                                            <li class="breadcrumb-item"><a href="{{url('admin')}}/slides">Slider </a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <form method="post"
                                    action="{{ url('admin/slides/create') }}" enctype="multipart/form-data">
                                    @method('POST')
