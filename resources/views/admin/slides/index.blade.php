                        ...
                        <table class="user-list-table table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th width="5%">{{trans('admin.Order')}}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">{{$row->order_field}}</td>
                                    <td class="center"><img src="{{url('/')}}/uploads/{{$row->main_image}}" width="30"></td>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-danger btn-xs" href="{{$module}}/delete/{{$row->id}}" title="{{trans('admin.Delete')}}" data-title="{{trans('admin.Confirmation message')}}" data-confirm="{{trans('admin.Are you sure you want to delete this slide')}}?">
