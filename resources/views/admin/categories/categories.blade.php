                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ url('admin/categories/create') }}" id="upload_form"
                                    ...
                                    <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                        <button type="submit" id="upload"
                                            class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Add New Category</button>
                                            ...
                                            <a href="javascript:void(0)">
                                                <div
                                                    ...
                                                    <div class="dropdown my-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            ...
                                                            <a class="dropdown-item" href="{{ url('admin/categories/view/'.$category->id) }}">
                                                            ...
                                                            {{-- <a class="dropdown-item" href="{{ url('admin/categories/delete'.$category->id) }}">
                                                                <i data-feather="trash-2" class="align-middle mr-50"></i>
                                                                <span class="align-middle">Delete</span>
                                                            </a> --}}
                                                            {{-- <form class="dropdown-item" action="{{ url('admin/categories/delete'.$category->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                              ...
                                                              {!! Form::open(['method' => 'DELETE', 'url' => url('admin/categories/delete'.$category->id), 'style' => 'display:inline']) !!}
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <button type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">
                                                        ...
                                                        <a href="{{ url('admin/sub-categories/'.$category->id) }}" style="color: aliceblue;">Sub
                                                            Categories
                                                        </a></button>
