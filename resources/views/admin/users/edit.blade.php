...
@section('content')
  <!-- users edit start -->
                <section class="app-user-edit">
                    <div class="card">
                        <h5 class="card-header">تعديل موظف</h5>
                                <div class="card-body">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="admin/dashboard">الرئيسية</a></li>
                                            <li class="breadcrumb-item"><a href="admin/{{$module}}">عرض الفنيين</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">تعديل فني</li>
                                        </ol>
                                    </nav>
                                </div>
                    </div>
