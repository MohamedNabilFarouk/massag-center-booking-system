         <!-- Account Tab starts -->
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <div class="media mb-2">
                                        <img src="@if(@$row->profile_img) {{url('uploads/'.$row->profile_img)}} @else new-admin/app-assets/images/avatars/2.png @endif" alt="users avatar" class="user-avatar users-avatar-shadow rounded mr-2 my-25 cursor-pointer" height="90" width="90" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::select($input, $areas, explode(",",$row->area_id), ["multiple",'class' => 'select2 form-control','placeholder'=>"أختر"]) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="area_id">الفرع</label>
                                                    @php $input='branch_id'; @endphp
                                                    {!! Form::select($input, $branches, explode(",",$row->branch_id), ['class' => 'select2 form-control','placeholder'=>"أختر"]) !!}
