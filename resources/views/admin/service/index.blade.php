					...
					<div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__("Services")}} </h4><a href='{{route('Services.create')}}'><span class="badge badge-lg badge-success">{{__("create")}} +</span></a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><strong>#</strong></th>
                                                <th><strong>{{__("Service")}}</strong></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{route('Services.edit',$row->id)}}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                        <form action="{{route('Services.destroy',$row->id)}}" method="post" id='delform' style="display: inline-block">
                                                            @csrf
                                                            @method('delete')
