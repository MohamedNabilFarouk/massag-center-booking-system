...
<div class="col-xl-12 col-lg-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{__("Service")}} / {{__("create")}}</h4>
        </div>
        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('Services.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row mt-5">
                                    ...
                                    <div class="mb-3 row mt-5">
                                        ...
                                        <div class="col-sm-4 ">
                                            <input type='number' name="price" class="form-control form-control-lg" value="{{ old('price') }}" required placeholder="{{__("Price")}}">
                                        </div>
                                    </div>
