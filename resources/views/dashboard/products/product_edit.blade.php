            ...
            <div class="content-wrapper">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="todo-modal needs-validation" method="post" action="{{ route('products.update',$product->id) }}" id="upload_form"
                            ...
                            <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                    <div class="action-tags">
                                        <div class="media mb-2">
                                            ...
                                            <img src="{{$image->image_name}}" alt="users avatar"
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="title_ar" name="title_ar"
                                                        class="new-todo-item-title form-control"
                                                        placeholder="Title" value="{{$product->title_ar}}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-12">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <select class="select2 form-control" id="category_id"
                                                        ...
                                                        <option data-img="{{url('')}}{{$item->logo}}" value="{{ $item->id }}" {{ $item->id == $product->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group position-relative">
                                                 <label for="sub_category_id"
                                                    ...
                                                    <select class="select2 form-control" id="sub_category_id"
                                                        ...
                                                        <option value="{{$product->sub_category_id}}" selected>{{$product->sub_category->title}}</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="prepare_time" name="prepare_time"
                                                        class="new-todo-item-title form-control"
                                                        placeholder="prepare_time" value="{{$product->prepare_time}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description_ar"
                                                        id="description_ar"
                                                        class="form-control">{{$product->description_ar}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group my-1">
                                    <button type="submit" class="btn btn-primary add-todo-item ml-1">Update</button>
