...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="content">
        ...
        <div class="form-group {{ $errors->has($input) ? 'has-error' : '' }}">
            <label class="" for="name">{{trans('admin.Date')}}<em class='red'>*</em></label>
            <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has($input) ? 'has-error' : '' }}">
            <label class="" for="name">{{trans('admin.Summary')}}<em class='red'>*</em></label>
            <div class="col-md-10">
        ...
        <div class="form-group {{ $errors->has($input) ? 'has-error' : '' }}">
            <label class="" for="name">{{trans('admin.Summary')}} Arabic<em class='red'>*</em></label>
            <div class="col-md-10">
        ...
        <div class="form-group {{ $errors->has($input) ? 'has-error' : '' }}">
            <label class="" for="name">{{trans('admin.Image')}}<em class='red'>*</em></label> {{trans("front.jpg,png,jpeg")}}, {{trans("front.Allowed max file size 4MB")}} {{trans("admin.Recommended resolution")}} 600x480
            <div class="row">
            <div class="col-md-5">
        ...
        <div class="form-group">
            <label class="" for="name">{{trans('admin.Published')}}<em class='red'>*</em></label>
            <div class="col-md-10">
