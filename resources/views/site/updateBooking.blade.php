...
@stop
 @section('content')
    ...
    <div class="panel panel-primary">
      <form class="form-horizontal" id="multistep_form" action="{{route('site.dobooking.update',$booking->id)}}" method="post">
        @csrf
        @method('put')
            <!-- Form One-->
            <fieldset id="account">
                    ...
                    <div class="aon-booking-wrap d-flex align-items-center justify-content-center">
                      <div class="aon-booking-form mt-5">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <h2 class="aon-form-title">{{__('Update An Appointment')}}</h2>
                                </div>
                                @if( !isset($package))
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="aon-inputicon-box">
                                             <select class="form-select" name='package_id' id='package' aria-label="i'll choose my insuance plan?">
                                                ...
                                                {{-- <option @if($p->is_special == 1) class="special" @elseif($p->with_special == 1) class="with_special" @endif   @if($booking->package_id == $p->id) selected @endif value='{{$p->id}}'>{{$p->title}}</option> --}}
                                               @endforeach
                                            </select>
...
{{-- Morocco Spa profissional --}}
                                <div class="col-md-12" id='special_prof'>
                                    <div class="form-group">
                                        <label >{{__("Which Morocco Spa Professional?")}}</label>
                                        <div class="aon-inputicon-box">
...
{{--
                            ...
                            <div class="col-md-12">
                                ...
                                <button  type="submit"  class="site-button w-100">{{__("Continue to Book")}} <i class="feather-arrow-right"></i> </button>
...
// }
                                ...
                                var option = ' <div class="sf-doc-timing-slots-detail col-md-6" style="width:40%; margin:5px 30px 0 0"><input type="radio" id="from" name="from" value="'+ test +'"> <span>'+ date_dispaly +  '<br>'+new Date(response['data'][i]).toDateString()+'</span>  </div>';
